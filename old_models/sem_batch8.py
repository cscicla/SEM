...
def save_images(data, output, target, epoch, testflag):
    ...
    save_folder = Path("/home/crcvreu.student10/run/sem_batch8/masks/")
...
def train(model, device, train_loader, optimizer, criterion, epoch, batch_size, file):
    '''
...
def test(model, device, test_loader, criterion, epoch, batch_size, file):
    '''
    Tests the model.
    model: The model to train. Should already be in correct device.
    device: 'cuda' or 'cpu'.
...
def evaluation(f):
    ...
    model = torch.load('/home/crcvreu.student10/run/sem_batch8/final_model_filled2.pth')
    model.eval()
    ...
    img_dir = Path('/home/crcvreu.student10/run/sem_batch8/test/data/')
    mask_dir = Path("/home/crcvreu.student10/run/sem_batch8/test/output/")
    target_mask_dir = Path("/home/crcvreu.student10/run/sem_batch8/masks/target/")
    final_mask_dir = Path("/home/crcvreu.student10/run/sem_batch8/masks/final/")
...
def run_main(FLAGS, file):
    ...
    model = UNet_PV.to(device)
    save_folder = "/home/crcvreu.student10/run/sem_batch8/masks"
    checkpoint_folder = "/home/crcvreu.student10/run/sem_batch8/checkpoints"
    ...
    #################### LOAD DATA ####################
    # image_dir = '/home/crcvreu.student10/run/sem_batch8/data/'
    # label_dir = '/home/crcvreu.student10/run/sem_batch8/output'
    train_image_dir = '/home/crcvreu.student10/run/sem_batch8/train/data/'
    train_label_dir = '/home/crcvreu.student10/run/sem_batch8/train/output/'
    test_image_dir = '/home/crcvreu.student10/run/sem_batch8/test/data/'
    test_label_dir = '/home/crcvreu.student10/run/sem_batch8/test/output/'
    ...
    best_accuracy = 0.0
    checkpoint_path = '/home/crcvreu.student10/run/sem_batch8/checkpoints/model_filled2.pth'
    ...
    torch.save(model, '/home/crcvreu.student10/run/sem_batch8/final_model_filled2.pth')
    ...
    plt.grid(True)
    # plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_batch8/graphs/Train_Test_loss_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    # plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_batch8/graphs/Train_Test_acc_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_batch8/graphs/Train_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_batch8/graphs/Test_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_batch8/graphs/Train_Test_f1_model.jpg")
    plt.clf()
    file.write("\nTraining finished")
