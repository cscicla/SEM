...
def save_images(data, output, target, epoch, testflag):
    ...
    save_folder = Path("/home/crcvreu.student10/run/sem_linknet/masks/")
...
def evaluation(f):
    ...
    sem_model = smp.Linknet(
        encoder_name="resnet34",        # choose encoder, e.g. mobilenet_v2 or efficientnet-b7
        encoder_weights="imagenet",     # use `imagenet` pre-trained weights for encoder initialization
        in_channels=1,                  # model input channels (1 for gray-scale images, 3 for RGB, etc.)
        classes=6,                      # model output channels (number of classes in your dataset)
    )
    model = sem_model.to(device)
    # model = smp.Unet()
    # model = model.to(device)
    model = torch.load('/home/crcvreu.student10/run/sem_linknet/final_model_filled2.pth')
    model.eval()
    ...
    img_dir = Path('/home/crcvreu.student10/run/sem_linknet/test/data/')
    mask_dir = Path("/home/crcvreu.student10/run/sem_linknet/test/output/")
    target_mask_dir = Path("/home/crcvreu.student10/run/sem_linknet/masks/target/")
    final_mask_dir = Path("/home/crcvreu.student10/run/sem_linknet/masks/final/")
...
def run_main(FLAGS, file):
    ...
    model = sem_model.to(device)
    save_folder = "/home/crcvreu.student10/run/sem_linknet/masks"
    checkpoint_folder = "/home/crcvreu.student10/run/sem_linknet/checkpoints"
    ...
    #################### LOAD DATA ####################
    # image_dir = '/home/crcvreu.student10/run/sem_linknet/data/'
    # label_dir = '/home/crcvreu.student10/run/sem_linknet/output'
    train_image_dir = '/home/crcvreu.student10/run/sem_linknet/train/data/'
    train_label_dir = '/home/crcvreu.student10/run/sem_linknet/train/output/'
    test_image_dir = '/home/crcvreu.student10/run/sem_linknet/test/data/'
    test_label_dir = '/home/crcvreu.student10/run/sem_linknet/test/output/'
    ...
    best_accuracy = 0.0
    checkpoint_path = '/home/crcvreu.student10/run/sem_linknet/checkpoints/model_filled2.pth'
    ...
    torch.save(model, '/home/crcvreu.student10/run/sem_linknet/final_model_filled2.pth')
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_linknet/graphs/Train_Test_loss_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_linknet/graphs/Train_Test_acc_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_linknet/graphs/Train_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_linknet/graphs/Test_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_linknet/graphs/Train_Test_f1_model.jpg")
    plt.clf()
    file.write("\nTraining finished")
