...
def save_images(data, output, target, epoch, testflag):
    ...
    save_folder = Path("/home/crcvreu.student10/run/sem_manet/masks/")
...
def test(model, device, test_loader, file, epoch, class_weights):
    ...
    file.write('Average Test Accuracy: {:.4f}\n'.format(test_acc))
...
def run_main(FLAGS, file):
    ...
    save_folder = "/home/crcvreu.student10/run/sem_manet/masks"
    checkpoint_folder = "/home/crcvreu.student10/run/sem_manet/checkpoints"
    ...
    #################### LOAD DATA ####################
    # image_dir = '/home/crcvreu.student10/run/sem_manet/data/'
    # label_dir = '/home/crcvreu.student10/run/sem_manet/output'
    train_image_dir = '/home/crcvreu.student10/run/sem_manet/train/data/'
    train_label_dir = '/home/crcvreu.student10/run/sem_manet/train/output/'
    test_image_dir = '/home/crcvreu.student10/run/sem_manet/test/data/'
    test_label_dir = '/home/crcvreu.student10/run/sem_manet/test/output/'
    ...
    best_accuracy = 0.0
    checkpoint_path = '/home/crcvreu.student10/run/sem_manet/checkpoints/model_filled2.pth'
    ...
    torch.save(model, '/home/crcvreu.student10/run/sem_manet/final_model_filled2.pth')
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_manet/graphs/Train_Test_loss_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_manet/graphs/Train_Test_acc_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_manet/graphs/Train_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_manet/graphs/Test_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_manet/graphs/Train_Test_f1_model.jpg")
    plt.clf()
...
model = sem_model.to(device)
model = torch.load('/home/crcvreu.student10/run/sem_manet/final_model_filled2.pth')
model.eval()

classes = ["background", "silver", "glass", "silicon", "void", "interfacial void"]
f1_dict = {"background":[], "silver":[], "glass":[], "silicon":[], "void":[], "interfacial void":[]}

img_dir = Path('/home/crcvreu.student10/run/sem_manet/test/data/')
mask_dir = Path("/home/crcvreu.student10/run/sem_manet/test/output/")
target_mask_dir = Path("/home/crcvreu.student10/run/sem_manet/masks/target/")
final_mask_dir = Path("/home/crcvreu.student10/run/sem_manet/masks/final/")
