...
model = sem_model.to(device)
model = torch.load('/home/crcvreu.student10/run/sem_linkne/final_model_filled2.pth')
model.eval()

classes = ["background", "silver", "glass", "silicon", "void", "interfacial void"]
f1_dict = {"background":[], "silver":[], "glass":[], "silicon":[], "void":[], "interfacial void":[]}

img_dir = Path('/home/crcvreu.student10/run/sem_linkne/test/data/')
mask_dir = Path("/home/crcvreu.student10/run/sem_linkne/test/output/")
target_mask_dir = Path("/home/crcvreu.student10/run/sem_linkne/masks/target/")
final_mask_dir = Path("/home/crcvreu.student10/run/sem_linkne/masks/final/")
