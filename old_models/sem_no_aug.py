...
def save_images(data, output, target, epoch, testflag):
    ...
    save_folder = Path("/home/crcvreu.student10/run/sem_no_aug/masks/")
...
def run_main(FLAGS, file):
    ...
    save_folder = "/home/crcvreu.student10/run/sem_no_aug/masks"
    checkpoint_folder = "/home/crcvreu.student10/run/sem_no_aug/checkpoints"
    ...
    #################### LOAD DATA ####################
    # image_dir = '/home/crcvreu.student10/run/sem_no_aug/data/'
    # label_dir = '/home/crcvreu.student10/run/sem_no_aug/output'
    train_image_dir = '/home/crcvreu.student10/run/sem_no_aug/train/data/'
    train_label_dir = '/home/crcvreu.student10/run/sem_no_aug/train/output/'
    test_image_dir = '/home/crcvreu.student10/run/sem_no_aug/test/data/'
    test_label_dir = '/home/crcvreu.student10/run/sem_no_aug/test/output/'
    ...
    best_accuracy = 0.0
    checkpoint_path = '/home/crcvreu.student10/run/sem_no_aug/checkpoints/model_filled2.pth'
    ...
    torch.save(model, '/home/crcvreu.student10/run/sem_no_aug/final_model_filled2.pth')
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_no_aug/graphs/Train_Test_loss_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_no_aug/graphs/Train_Test_acc_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_no_aug/graphs/Train_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_no_aug/graphs/Test_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_no_aug/graphs/Train_Test_f1_model.jpg")
    plt.clf()
...
model = torch.load('/home/crcvreu.student10/run/sem_no_aug/final_model_filled2.pth')
model.eval()

classes = ["background", "silver", "glass", "silicon", "void", "interfacial void"]
f1_dict = {"background":[], "silver":[], "glass":[], "silicon":[], "void":[], "interfacial void":[]}

img_dir = Path('/home/crcvreu.student10/run/sem_no_aug/test/data/')
mask_dir = Path("/home/crcvreu.student10/run/sem_no_aug/test/output/")
target_mask_dir = Path("/home/crcvreu.student10/run/sem_no_aug/masks/target/")
final_mask_dir = Path("/home/crcvreu.student10/run/sem_no_aug/masks/final/")
