...
class PVDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform: # random cropping and flipping to help generalizability
            ...
            # image = transforms.ColorJitter(brightness=0.5) 
...
def save_images(data, output, target, epoch, testflag):
    ...
    save_folder = Path("/home/crcvreu.student10/cm_sem/masks/")
...
def evaluate(model):
    ...
    model = torch.load('/home/crcvreu.student10/cm_sem/final_model_filled2.pth')
    model.eval()
    ...
    img_dir = Path('/home/crcvreu.student10/cm_sem/test/data/')
    mask_dir = Path("/home/crcvreu.student10/cm_sem/test/output/")
    target_mask_dir = Path("/home/crcvreu.student10/cm_sem/masks/target/")
    final_mask_dir = Path("/home/crcvreu.student10/cm_sem/masks/final/")
    cm_dir = Path("/home/crcvreu.student10/cm_sem/cms/")
    ...
    with open('f1results.txt', 'a') as file_output:
        ...
        for file_path in img_dir.iterdir():
            if file_path.suffix in {'.png', '.tif', '.jpg'}:
                ...
                label_np = np.load(label_name)
                label = torch.from_numpy(label_np)  # Convert label to tensor
                label_flat = label.long().to(device)
                label_flat = label_flat.cpu().numpy().flatten()
                ...
                print("Shape of pred_np:", pred.shape) # (768, 1024)
                ...
                cm = confusion_matrix(label_flat, pred_flat, labels=np.arange(len(classes)))
                conf_matrix += cm
                ...
                # print(cm_path)
                cm_path = cm_dir / (file_path.stem + "_cm.png")
                plt.savefig(cm_path)  
                plt.clf()            
            print('\n=============================================\n')
            file_output.write('\n=============================================\n')
...
def run_main(FLAGS, file):
    ...
    save_folder = "/home/crcvreu.student10/cm_sem/masks"
    checkpoint_folder = "/home/crcvreu.student10/cm_sem/checkpoints"
    ...
    #################### LOAD DATA ####################
    # image_dir = '/home/crcvreu.student10/cm_sem/data/'
    # label_dir = '/home/crcvreu.student10/cm_sem/output'
    train_image_dir = '/home/crcvreu.student10/cm_sem/train/data/'
    train_label_dir = '/home/crcvreu.student10/cm_sem/train/output/'
    test_image_dir = '/home/crcvreu.student10/cm_sem/test/data/'
    test_label_dir = '/home/crcvreu.student10/cm_sem/test/output/'
    ...
    best_accuracy = 0.0
    checkpoint_path = '/home/crcvreu.student10/cm_sem/checkpoints/model_filled2.pth'
    ...
    torch.save(model, '/home/crcvreu.student10/cm_sem/final_model_filled2.pth')
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/cm_sem/graphs/Train_Test_loss_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/cm_sem/graphs/Train_Test_acc_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/cm_sem/graphs/Train_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/cm_sem/graphs/Test_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/cm_sem/graphs/Train_Test_f1_model.jpg")
    plt.clf()
