...
def save_images(data, output, target, epoch, testflag):
    ...
    save_folder = "/home/crcvreu.student10/run/l2_drop4/masks/"
...
def run_main(FLAGS, file):
    ...
    checkpoint_folder = "/home/crcvreu.student10/run/l2_drop4/checkpoints"
    ...
    #################### LOAD DATA ####################
    image_dir = '/home/crcvreu.student10/run/l2_drop4/data/'
    label_dir = '/home/crcvreu.student10/run/l2_drop4/output'
    train_image_dir = '/home/crcvreu.student10/run/l2_drop4/train/data/'
    train_label_dir = '/home/crcvreu.student10/run/l2_drop4/train/output/'
    test_image_dir = '/home/crcvreu.student10/run/l2_drop4/test/data/'
    test_label_dir = '/home/crcvreu.student10/run/l2_drop4/test/output/'
    ...
    best_accuracy = 0.0
    checkpoint_path = '/home/crcvreu.student10/run/l2_drop4/checkpoints/model_filled2.pth'
    ...
    torch.save(model, '/home/crcvreu.student10/run/l2_drop4/final_model_filled2.pth')
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("/home/crcvreu.student10/run/l2_drop4/graphs/Train_Test_loss_model.jpg")
    plt.clf()
    # plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("/home/crcvreu.student10/run/l2_drop4/graphs/Train_Test_acc_model.jpg")
    plt.clf()
    plt.show()
    ...
    plt.grid(True)
    plt.savefig("/home/crcvreu.student10/run/l2_drop4/graphs/Train_f1_per_class_model.jpg")
    plt.clf()
    # plt.show()
    ...
    plt.legend(classes, loc='upper left')
    plt.grid(True)
    plt.savefig("/home/crcvreu.student10/run/l2_drop4/graphs/Test_f1_per_class_model.jpg")
    plt.clf()
    # plt.show()
    ...
    plt.grid(True)
    plt.savefig("/home/crcvreu.student10/run/l2_drop4/graphs/Train_f1_model.jpg")
    plt.clf()
    # plt.show()
    ...
    plt.grid(True)
    plt.savefig("/home/crcvreu.student10/run/l2_drop4/graphs/Test_f1_model.jpg")
    plt.clf()
    # plt.show()
...
model = UNet_PV().to(device)
model = torch.load('/home/crcvreu.student10/run/l2_drop4/final_model_filled2.pth')
model.eval()
...
img_dir = '/home/crcvreu.student10/run/l2_drop4/train/data/'
for filename in os.listdir(img_dir):
  ...
  if file_path.suffix == '.png' or file_path.suffix == '.tif' or file_path.suffix == '.jpg':
        ...
        #print target mask
        mask_dir = "/home/crcvreu.student10/run/l2_drop4/train/output/"
        ...
        imsave(os.path.join("/home/crcvreu.student10/run/l2_drop4/masks/target", os.path.splitext(os.path.basename(file_path))[0] + "_target.png"), pred_mask)
        ...
        # Save images as PNG files with epoch number in the filename
        # os.makedirs("/home/crcvreu.student10/run/l2_drop4/masks/final", exist_ok=True)
        imsave(os.path.join("/home/crcvreu.student10/run/l2_drop4/masks/final", os.path.splitext(os.path.basename(file_path))[0] + "_final.png"), pred_mask)
