...
def save_images(data, output, target, epoch, testflag):
    ...
    save_folder = Path("/home/crcvreu.student10/run/sem_new/masks/")
...
def run_main(FLAGS, file):
    ...
    save_folder = "/home/crcvreu.student10/run/sem_new/masks"
    checkpoint_folder = "/home/crcvreu.student10/run/sem_new/checkpoints"
    ...
    #################### LOAD DATA ####################
    # image_dir = '/home/crcvreu.student10/run/sem_new/data/'
    # label_dir = '/home/crcvreu.student10/run/sem_new/output'
    train_image_dir = '/home/crcvreu.student10/run/sem_new/train/data/'
    train_label_dir = '/home/crcvreu.student10/run/sem_new/train/output/'
    test_image_dir = '/home/crcvreu.student10/run/sem_new/test/data/'
    test_label_dir = '/home/crcvreu.student10/run/sem_new/test/output/'
    ...
    best_accuracy = 0.0
    checkpoint_path = '/home/crcvreu.student10/run/sem_new/checkpoints/model_filled2.pth'
    ...
    torch.save(model, '/home/crcvreu.student10/run/sem_new/final_model_filled2.pth')
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_new/graphs/Train_Test_loss_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_new/graphs/Train_Test_acc_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_new/graphs/Train_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_new/graphs/Test_f1_per_class_model.jpg")
    plt.clf()
    ...
    plt.grid(True)
    plt.ylim(0,1)
    plt.savefig("/home/crcvreu.student10/run/sem_new/graphs/Train_Test_f1_model.jpg")
    plt.clf()
...
model = torch.load('/home/crcvreu.student10/run/sem_new/final_model_filled2.pth')
model.eval()

classes = ["background", "silver", "glass", "silicon", "void", "interfacial void"]
f1_dict = {"background":[], "silver":[], "glass":[], "silicon":[], "void":[], "interfacial void":[]}

img_dir = Path('/home/crcvreu.student10/run/sem_new/test/data/')
mask_dir = Path("/home/crcvreu.student10/run/sem_new/test/output/")
target_mask_dir = Path("/home/crcvreu.student10/run/sem_new/masks/target/")
final_mask_dir = Path("/home/crcvreu.student10/run/sem_new/masks/final/")
